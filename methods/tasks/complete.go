...
// Complete returns "rtm.tasks.complete" method instance.
func Complete(timeline string, listID string, taskseriesID string, taskID string) *methods.Method {
	name := "rtm.tasks.complete"
